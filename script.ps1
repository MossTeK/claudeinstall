# 1. Download official installer to Public folder
...
# 2. Configure Active Setup for all future / other users on login
# Active Setup executes StubPath once per user early in logon if not yet run
...
# 3. Fire install immediately for whoever is actively logged in right now
